...
* Asks you the new version, add a new entry on CHANGELOG.md. Commit and pushes changes
* Creates a normal git tag with this name `v{version entered}` and push it to origin master
* Builds auth0-university as a module, and publish it to npm
